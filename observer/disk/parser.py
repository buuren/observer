...
class DiskStats:
    def __init__(self, observer):
        ...
        self.observer.proc_file_dictionary.append(self.metric_key)
    ...
    def calculate_values(self, index):
        ...
        self.observer.raw_values[self.metric_key][index] = disk_stats
    ...
    def parse_diskstats(self, index):
        return {
            ...
            } for line in self.observer.file_content[index][self.metric_key]['/proc/diskstats']
        }
    ...
    def parse_partitions(self, index, read_diskstats):
        d = {part.split()[-1]: {
                ...
                "minor": part.split()[-3],
                "major": part.split()[-4]
            } for part in self.observer.file_content[index][self.metric_key]['/proc/partitions'][2:]
    ...
    def parse_mounts(self, index, read_partitions):
        d = {
            ...
            } for device_data in self.observer.file_content[index][self.metric_key]['/proc/mounts']
        }
